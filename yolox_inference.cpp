//
// Created by 86187 on 2022-05-01.
//
...
//        std::cout << device_name << std::endl;
        ...
        const std::string input_model = "/home/pi/Code/OpenVINO_Cpp/4_yolox_nano.xml"; //../yolox_n_test.xml
//        const std::string input_model_bin = "../yolox_n_test.bin";
        const std::string input_image_path = "/home/pi/Code/OpenVINO_Cpp/20220420T214810.jpg";
        const std::string device_name = "MYRIAD"; //MYRIAD
...
//        double t_start = cv::getTickCount();
        ...
        double delta_t = 0.0;
        for (int i=0; i< 50; i++){
            double t_1 = std::clock();
            cv::Mat image = imread_t(input_image_path);
            cv::Mat pr_img = static_resize(image);
            double t_2 = std::clock();
            delta_t = t_2 - t_1;
            t += delta_t;
        ...
        double spendTime = (double)( t_end - t_start ) / (50*CLOCKS_PER_SEC);
        double FPS = 1 / spendTime;
        std::cout << "FPS:" << FPS << std::endl;
        std::cout << "t_resize:" << t/CLOCKS_PER_SEC << std::endl;
